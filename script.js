const livros = [
  ...
  },
  {
    ...
    precoAlugar: 32,
    genero: "suspense",
    imagem: "imagens/o-silencio-dos-inocentes.jpg",
  },
  {
    id: 5,
    ...
    precoAlugar: 29,
    genero: "suspense",
    imagem: "imagens/a-garota-no-trem.jpg",
  },
  {
    id: 6,
    titulo: "It:A Coisa",
  ...
  },
  {
    ...
    precoAlugar: 20,
    genero: "autoajuda",
    imagem: "imagens/Os-7-Hábitos-das-Pessoas-Altamente-Eficazes.jpg",
  },
  {
    id: 9,
    ...
    precoAlugar: 32,
    genero: "autoajuda",
    imagem: "imagens/O-Poder-do-Hábito.png",
  },
  {
    id: 10,
  ...
  {
    id: 14,
    titulo: "A Arte de Programar Computadores",
    autor: "Donald Knuth",
    precoComprar: 140,
    precoAlugar: 96,
    genero: "tecnologia",
  ...
  {
    id: 23,
    titulo: "1499: O Brasil Antes de Cabral",
    autor: "André Chelotti",
    precoComprar: 45,
    precoAlugar: 36,
    genero: "historia",
  },
  {
    id: 24,
    titulo: "Os Donos do Poder",
    autor: "Raymundo farao",
    precoComprar: 70,
    precoAlugar: 52,
    genero: "historia",
  },
  ...
  livrosFiltrados.forEach((livro) => {
    ...
    livroElem.innerHTML = `
      <div style="display:flex;align-items:center;gap:12px;">
        <img src="${livro.imagem || "imagens/livro_padrao.jpg"}" alt="${
      livro.titulo
    }" class="img-livro"/>
        <div>
...
function renderizarBebidas(tipo = "todos") {
  ...
  const bebidasFiltradas =
    tipo === "todos" ? bebidas : bebidas.filter((b) => b.tipo === tipo);
...
function atualizarContadorCarrinho() {
  ...
  if (total === 0) {
    document.querySelector(
      '[data-target="aba-carrinho"]'
    ).textContent = `Carrinho (0)`;
  } else {
    document.querySelector(
      '[data-target="aba-carrinho"]'
    ).textContent = `Carrinho (${total})`;
  }
}

function adicionarCarrinho(idProduto, tipo) {
  const index = carrinho.findIndex(
    (item) => item.idProduto === idProduto && item.tipo === tipo
  );
  if (index >= 0) {
